...
import com.org.system.service.manager.RolePermissionService;
import com.org.system.service.manager.RoleService;
...
//		while(iterator.hasNext()){
		...
		//User user=(User) s.getAttribute("user");
			...
			if(user.getId().intValue()==id.intValue()){
				PrincipalCollection pc= (PrincipalCollection) session.getAttribute(String.valueOf(id));
				//清空该用户权限缓存
